...
import numpy as np
import cv2
from torch_yolo.util import *
import argparse
import os
import os.path as osp
from torch_yolo.darknet import Darknet
...
base_path = 'C:/Users/YY/Documents/Deep_Learning/CNN_model/torch-yolov3'
...
def arg_parse():
    ...
    parser.add_argument("--cfg", dest='cfgfile', help="Config file", default="cfg/yolo.cfg", type=str)
...
for num_bbox in range(output.size(0)):
    img = write(output[num_bbox], loaded_ims)
...
# FINAL = np.array(loaded_ims).squeeze(0)
# imageio.imwrite(osp.join(base_path, 'data/output/outfile.jpg'), FINAL)
