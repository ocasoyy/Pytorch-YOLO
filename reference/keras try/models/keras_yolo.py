...
from models.keras_darknet19 import (DarknetConv2D, DarknetConv2D_BN_Leaky, darknet_body)
...
def preprocess_true_boxes(true_boxes, anchors, image_size):
    ...
    assert height % pixel == 0, 'Image sizes in YOLO_v2 must be multiples of 32.'
    assert width % pixel == 0, 'Image sizes in YOLO_v2 must be multiples of 32.'
    conv_height = height // pixel
    conv_width = width // pixel
